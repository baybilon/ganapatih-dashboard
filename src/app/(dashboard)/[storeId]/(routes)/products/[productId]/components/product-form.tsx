...
export const ProductForm : React.FC<ProductFormProps> = ({
    ...
    const otigin = useOrigin();
    const [open, setOpen] = useState(false);
    const [loading, setLoading] = useState(false);

    const title = initialData ? "Edit a Product." : "Create a new product.";
    const desccription = initialData ? "Edit Product." : "Add new product.";
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input disabled={loading} placeholder="1000.00" {...field}/>
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
                        ...
                        render={({field}) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                    ...
                                    <div className="space-y-1 leading-none">
                                        ...
                                        <FormDescription>
                                            This product will appear on the store
                                        </FormDescription>
                                    </div>
                            </FormItem>
                        )}
